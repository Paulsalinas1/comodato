...
import { ModalDesComponent } from '../modal-des/modal-des.component';
import { MAT_DIALOG_DATA, MatDialogRef } from '@angular/material/dialog';

@Component({
  selector: 'app-modal-comodato',
  standalone: false,
  templateUrl: './modal-comodato.component.html',
  styleUrl: './modal-comodato.component.css'
})
export class ModalComodatoComponent {
  form!: FormGroup;
  pasoActual = 0;
  campos: Campo[] = [];
  ...
  // Opcional: llamar a una función para guardar automáticamente
  // this.guardarCambios();
