...
@Component({
  ...
  standalone: false,
  templateUrl: './modal-des2.component.html',
  styleUrl: './modal-des2.component.css',
})
export class ModalDes2Component implements OnInit {
  form!: FormGroup;
  pasoActual = 0;
  campos: Campo[] = [];
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<ModalDes2Component>,
